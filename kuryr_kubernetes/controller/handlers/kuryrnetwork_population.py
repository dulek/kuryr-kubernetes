...
class KuryrNetworkPopulationHandler(k8s_base.ResourceEventHandler):
    ...
    def on_added(self, kuryrnet_crd):
        ...
        self._patch_kuryrnet_crd(kuryrnet_crd, populated=True)
        ...
        for node_ip in nodes:
            ...
            try:
                ...
                self._patch_kuryrnet_crd(kuryrnet_crd, populated=False)
                raise

    def _patch_kuryrnet_crd(self, kns_crd, populated=True):
