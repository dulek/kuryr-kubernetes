...
class TestKuryrNetworkHandler(test_base.TestCase):
    ...
    def test_on_present(self, m_get_ns, m_get_svc):
        ...
        self._handler._patch_kuryrnet_crd.assert_called()
    ...
    def test_on_present_deletion(self):
        kns_crd = self._kuryrnet_crd.copy()
        kns_crd['metadata']['deletionTimestamp'] = (
            mock.sentinel.deletion_timestamp)
        kuryrnetwork.KuryrNetworkHandler.on_present(self._handler, kns_crd)
        self._handler.delete_namespace_resources.assert_called_once()
    ...
    def test_on_present_existing(self, m_get_ns):
        ...
        self._handler._patch_kuryrnet_crd.assert_not_called()
    ...
    @mock.patch.object(driver_utils, 'get_services')
    def test_delete_namespace_resources(self, m_get_svc):
        net_id = mock.sentinel.net_id
        kns_crd = self._kuryrnet_crd.copy()
        ...
        kuryrnetwork.KuryrNetworkHandler.delete_namespace_resources(
    ...
    @mock.patch.object(driver_utils, 'get_services')
    def test_delete_namespace_resources_no_network(self, m_get_svc):
        crd_selector = mock.sentinel.crd_selector
        self._delete_ns_sg_rules.return_value = [crd_selector]
        m_get_svc.return_value = []
    ...
    @mock.patch.object(driver_utils, 'get_services')
    def test_delete_namespace_resources_no_sg_enforce(self, m_get_svc):
        net_id = mock.sentinel.net_id
        kns_crd = self._kuryrnet_crd.copy()
        kns_crd['status'] = {'netId': net_id}
        crd_selector = mock.sentinel.crd_selector
    ...
    @mock.patch.object(driver_utils, 'get_services')
    def test_delete_namespace_resources_finalizer_exception(self, m_get_svc):
        net_id = mock.sentinel.net_id
        kns_crd = self._kuryrnet_crd.copy()
        kns_crd['status'] = {'netId': net_id}
        crd_selector = mock.sentinel.crd_selector
